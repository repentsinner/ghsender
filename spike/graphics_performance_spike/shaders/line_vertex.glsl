/*
 * Stock Flutter Scene Vertex Shader (UnskinnedGeometry)
 * 
 * This is the baseline flutter_scene vertex shader to establish a working pipeline.
 * Once this works, we can incrementally modify it for line rendering.
 */
