...
#ifndef GHSENDER_SWIFT_H
#define GHSENDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ghsender",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC8ghsender11AppDelegate")
...
SWIFT_CLASS("_TtC8ghsender17MainFlutterWindow")
